...
from .views import news_list, news_detail, HomePageView, ContactPageView, errorPageView, LocalNewsView,ForeignNewsView, TechnologyNewsView, SportNewsView, NewsUpdateView, NewsDeleteView, NewsCreateView, adminpageview, \
    SearchResultList
...
urlpatterns = [
    ...
    path('adminpage/', adminpageview, name="admin_page"),
